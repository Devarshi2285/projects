...
<header>
        <div class="container">
            <div class="logo">
                <a href="base.html"><img src="assets\images\logo.jpg" alt=""></a>
            </div>
            <nav class="nav-1">
                ...
                <ul>
                    ...
                    <li><a href="base.html" onclick="function logout()">LOGOUT</a></li><?php } ?>
            ...
            <div class="container-2">
              ...
              <div class="nav-2">
                <ul>
                    ...
                    <li><a href="connecttrainer.html">Connect to trainer</a></li>
                </ul>
            </div>
            <div class="details">
                <div class="head">
