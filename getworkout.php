<?php
    ...
    if(isset($_POST['submit'])){
        $date=$_POST['in-date'];
        $sql="SELECT * FROM `excersize` WHERE username='" . $_SESSION['username'] . "' AND date='" . $date . "'";
...
<head>
    ...
    <link rel="stylesheet" href="/assets/css/getworkout.css">
            ...
            <div class="wrap">
                ...
                <div class="details">
                    ...
                    <div class="submitdate">
                        <button type="submit" name="submit">Get Workout</button>
                    </div>
                    </form>
                    <div class="body">
                        <table>
