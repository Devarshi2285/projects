<?php
        session_start();
                ...
                if(isset($_SESSION["username"])){
                    echo $_POST['cource'];
                    if($_POST['cource']=="c-4"){
                    header("Location:/c-4.php");
                }
                else if($_POST['cource']=="c-5"){
                    header("Location:/c-5.php");
                }
                else if($_POST['cource']=="c-6"){
                    header("Location:/c-6.php");
                }
            }
        }
?>
            ...
            <div class="container-2">
                ...
                <div class="wrap">
                    <div class="plan">
                        ...
                        <div class="buy"><button name="cource" value="c-4" type="submit">Buy Now</button></div>
                    </div>
                </div>
                <div class="wrap">
                    <div class="plan">
                        ...
                        <div class="buy"><button name="cource" value="c-5" type="submit">Buy Now</button></div>
                    </div>
                </div>
                <div class="wrap">
                    <div class="plan">
                        ...
                        <div class="buy"><button name="cource" value="c-6" type="submit">Buy Now</button></div>
                    </div>
                </div>
                </form>
            </div>
