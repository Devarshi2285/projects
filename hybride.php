<?php
        session_start();
                ...
                if(isset($_SESSION["username"])){
                    if($_POST['cource']=="c-7"){
                    header("Location:/c-7.php");
                }
                else if($_POST['cource']=="c-8"){
                    header("Location:/c-8.php");
                }
                else if($_POST['cource']=="c-9"){
                    header("Location:/c-9.php");
                }
            }
        }
?>
            ...
            <div class="container-2">
                ...
                <div class="wrap">
                    <div class="plan">
                        ...
                        <div class="buy"><button name="cource" value="c-7" type="submit">Buy Now</button></div>
                    </div>
                </div>
                <div class="wrap">
                    <div class="plan">
                        ...
                        <div class="buy"><button name="cource" value="c-8" type="submit">Buy Now</button></div>
                    </div>
                </div>
                <div class="wrap">
                    <div class="plan">
                        ...
                        <div class="buy"><button name="cource" value="c-9" type="submit">Buy Now</button></div>
                    </div>
                </div>
                </form>
            </div>
